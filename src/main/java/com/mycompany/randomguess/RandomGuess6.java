...
public class RandomGuess6 {
    public static void main(String[] args) {
        ...
        String playerName = JOptionPane.showInputDialog(null, "Enter your name");
             ...
             // Changing name with String method
               String upperName  = playerName.toUpperCase();
               String lowerName = playerName.toLowerCase();
               int nameLength = playerName.length();
               
               // Display a Greeting to the player
                  JOptionPane.showMessageDialog(null,"Hello, " + upperName + "! Let's play a Game.\n" + "Your name  " + lowerName +" is " + nameLength + " Character Long");
